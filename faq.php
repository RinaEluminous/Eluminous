<?php
$pageTitle = "Frequently Asked Questions About Eluminous Technologies"; //Put page title here
$metaDesc = "Get To Know Answers For Your Genera;L Queries In Frequently Asked Questions Section eLuminous Technologies"; //Put meta description here
$keywords = "Faq,Faq eLuminous Technologies, Frequently Asked Questions";//Put keywords here
?>
<?php require_once 'includes/head.php';?>
<!-- inner_banner -->
<section class="inner_banner">
	<img src="<?php echo SITE_URL; ?>images/about_us/about_us.png" alt="main_banner_bg" class="img-fluid">
...
<!-- inner_banner -->
<section id="faq" class="gray_bg mb-5">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingOne">
							...
							<a class="" role="button" data-toggle="collapse"  href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
								Q: Can you help me build concept of my app or website?
							</a>
							</h4>
						</div>
						<div id="collapseOne" class="panel-collapse in collapse show" data-parent="#accordion" role="tabpanel" aria-labelledby="headingOne" style="">
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingTwo">
							...
							<a class="collapsed" role="button" data-toggle="collapse"  href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
								Q: How can I be in touch with the developers according to my Time zone?
							</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingThree">
							...
							<a class="collapsed" role="button" data-toggle="collapse"  href="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
								Q: How do I track the hours spent on my project?
							</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingFour">
							...
							<a class="collapsed" role="button" data-toggle="collapse"  href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
								Q: Do I have to pay full amount at a stretch?
							</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingFive">
							...
							<a class="collapsed" role="button" data-toggle="collapse"  href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
								Q: What mode of payments available?
							</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingSix">
							...
							<a class="collapsed" role="button" data-toggle="collapse"  href="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
								Q: Will my code and Database be secure? Can you sign NDA?
							</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingSeven">
							...
							<a class="collapsed" role="button" data-toggle="collapse"  href="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
								Q: What if I face after delivery bugs?
							</a>
							</h4>
